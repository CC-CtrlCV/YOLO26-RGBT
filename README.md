...
本项目面向 RGB 可见光图像和红外图像的多模态目标检测任务，适合 KAIST、LLVIP、FLIR 等 RGBT 数据集实验，也适合夜间行人检测、安防监控、自动驾驶感知、无人机巡检和毕业设计/论文复现实验。
...
| [GitHub发布清单](项目文档/GitHub发布清单.md)         | 发布 GitHub 前需要检查的文件、路径和忽略项    |
