...
def load_inference_source(
    ...
    Args:
        ...
        rgbt (bool, optional): Whether to load paired RGB/infrared images as 4-channel RGBT inputs.
        rgbt_pair (list[str] | tuple[str, str], optional): Path tokens used to map RGB paths to infrared paths.
    ...
    if tensor:
        ...
        dataset = LoadImagesAndVideos(
            source, batch=batch, vid_stride=vid_stride, channels=channels, rgbt=rgbt, rgbt_pair=rgbt_pair
        )
